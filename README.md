...
* (опционально) дополнительное задание: создать файл, в котором путь к каждому файлу исходной структуры сопоставлен пути к файлу в конечной структуре.

## Выходные данные

Результат работы, который нужно прислать:
* архив с полученной структурой
* если выполнялось дополнительное задание - файл со списком соответствия путей.